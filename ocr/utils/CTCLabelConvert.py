# @Time    : 2021/7/31 下午3:50
# @Author  : cattree
# @File    : CTCLabelConvert
# @Software: PyCharm
# @explain :
...
if __name__ == '__main__':
    convert = CTCLabelConverter(character='/home/cattree/PycharmProjects/limapOCR/BoatnumProject/chinese_cht_dict.txt')
    data = '你好'
    data, lenth = convert.encode(data)
    print(data)
    print(lenth)
