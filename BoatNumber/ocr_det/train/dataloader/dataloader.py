...
def cal_error(vertices):
    ...
    x1, y1, x2, y2, x3, y3, x4, y4 = vertices
    err = cal_distance(x1, y1, x_min, y_min) + cal_distance(x2, y2, x_max, y_min) + cal_distance(x3, y3, x_max,
                                                                                                 y_max) + cal_distance(
        x4, y4, x_min, y_max)
    return err
...
class DetDataModule(pytorch_lightning.LightningDataModule):
    ...
    def __init__(
        ...
        # self.train_image_path = train_img_path
